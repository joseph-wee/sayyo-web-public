    ...
    <>
      <div className="relative pb-[264px] md720:pb-[173px] tall:pb-0">
        ...
        <div className="relative z-10 mx-auto top-0 pt-[200px] max-w-[1280px] md1920:pt-[10.42vw] md720:max-w-[328px] md720:pt-[74px]">
          ...
          />
          <h3 className="mb-[140px] text-center font-NanumSquare text-[38px] text-sayyo_wht leading-[45.6px] md1920:mb-[7.291vw] md1920:text-[1.979vw] md1920:leading-[2.375vw] md720:mb-[48px] md720:text-[11px] md720:leading-[13.2px]">
            내 주변에서 필요한
            <br />
            모든것들을 찾고 나누세요!
          </h3>
          ...
          <div className="relative mx-auto mb-[238px] pt-[48px] max-w-[1180px] md1920:mb-[12.396vw] md1920:pt-[2.5vw] md1920:w-[61.458vw] md720:mb-[55.34px] md720:pt-[7.18px]">
            ...
            <p className="text-sayyo_l2 text-center font-NanumSquare text-[28px] leading-[36.4px] md1920:text-[1.458vw] md1920:leading-[1.896vw] md720:text-[11px] md720:leading-[14.3px] md760:text-[11px]  md720:mb-[2.09px]">
              내주변의 이웃에게
            </p>
            <strong className="block mb-[9px] text-sayyo_l2 text-center font-NanumSquareRound text-[58px] font-normal leading-[75.4px] md1920:mb-[0.469vw] md1920:text-[3.021vw] md1920:leading-[3.927vw] md720:text-[16px] md720:leading-[20.8px] md720:mb-[2.27px]">
              요청하거나 해주세요
            </strong>
            <p className="text-sayyo_subtext text-center font-NanumSquare text-[18px] font-medium leading-[23.4px]  md720:text-[11px] md1920_970:text-[0.938vw] md1920_970:leading-[1.219vw] md970:text-[11px] md720:font-normal md720:leading-[14.3px]">
              당신의 재능을 나눠요
            </p>
          </div>
          {/** free */}
          <strong className="block text-sayyo_l2 text-center font-NanumSquareRound text-[58px] leading-[75.4px] tracking-[-1.16px] md1920:text-[3.021vw] md1920:leading-[3.927vw] md1920:tracking-[-0.06vw] md720:mb-[1.16px] md720:text-[16px] md720:leading-[20.8px] md720:tracking-[-0.32px]">
            무료
          </strong>
          <p className="mb-[64px] text-sayyo_subtext text-center font-NanumSquare text-[34px] font-medium leading-[44.2px] md1920:mb-[3.333vw] md1920:text-[1.771vw] md1920:leading-[2.302vw] md720:mb-[17.9px] md720:text-[9.419px] md720:leading-[12.245px] md720:tracking-[-0.188px]">
            주변의 이웃과 부담없이 연결해요
          </p>
          <div
        ...
        md720:mb-[88.83px] md720:pt-[14.43px] md720:pl-[16.4px] pr-[16px] md720:w-[328px] md720:h-[184px] md720:rounded-[6.649px]"
          >
            <div className="flex flex-col items-center mr-[52px] md1920:mr-[2.708vw] md720:mr-[10px]">
              ...
              <p
                className="
            mb-[13px] text-sayyo_l2 text-center font-NanumSquare text-[28px] font-bold leading-[36.4px] tracking-[-0.56px]
            ...
            md720:mb-[10.94px] md720:text-[11px] md720:leading-[14.3px] md720:tracking-[-0.22px]"
              ...
              <div
                className="w-[271px] text-sayyo_subtext text-center font-NanumSquare text-[20px] font-medium leading-[26px] tracking-[-0.4px]
            ...
            md720:w-[86px] md720:text-[10px] md720:leading-[13px] md720:tracking-[-0.2px]"
              >
                이웃에게 배우고 <br className="hidden md720:inline" /> 싶은게
                있나요? <br className="hidden md720:inline" /> 도움이 필요한
                것이 있나요? 주변에 <br className="hidden md720:inline" />{" "}
                물어보세요.
              </div>
            </div>
            <div
          ...
          md720:mr-[13px]"
            ...
            md720:w-[83px] md720:text-[10px] md720:leading-[13px] md720:tracking-[-0.2px]"
              >
                주변 이웃들이 <br className="hidden md720:inline" /> 필요한 일을
                할 수 <br className="hidden md720:inline" /> 있도록 돕고{" "}
                <br className="hidden md720:inline" /> 돈을 벌어보세요
              </div>
            </div>
            <div
              className="mr-[53px] w-[1px] h-[391px] border-l-[1px] border-l-sayyo_bg_more
          ...
          md720:mr-[15.6px] md720:h-[146px]"
            ...
            <div className="flex flex-col items-center">
              ...
              />
              <p
                className="mb-[13px] text-sayyo_l2 text-center font-NanumSquare text-[28px] font-bold leading-[36.4px] tracking-[-0.56px]
            md1920:mb-[0.677vw] md1920:text-[1.458vw] md1920:leading-[1.896vw] md1920:tracking-[-0.029vw]
            md720:mb-[10.94px] md720:text-[11px] md720:leading-[14.3px] md720:tracking-[-0.22px]"
              >
                판매
              ...
              <div
                className="w-[267px] text-sayyo_subtext text-center font-NanumSquare text-[20px] font-medium leading-[26px] tracking-[-0.4px]
            md1920:w-[14.115vw] md1920_970:text-[1.042vw] md1920:leading-[1.354vw] md1920:tracking-[-0.021vw]
            md970:text-[10px]
            md720:w-[75px] md720:text-[10px] md720:leading-[13px] md720:tracking-[-0.2px]"
              >
                ...
                주변에 팔고 필요한 물건을
                <br className="md720:hidden" />{" "}
                <br className="hidden md720:inline" /> 구매하세요
              </div>
            </div>
          </div>
          {/** find everything */}
        ...
        md720:w-[328px] md720:gap-[6px] md720:mb-[19px]"
          >
            <p
              className="shrink-0 w-[418px] text-sayyo_l2 font-NanumSquareRound text-[43px] leading-[47.3px] tracking-[-0.86px]
          md1920:w-[22.156vw] md1920:text-[2.24vw] md1920:leading-[2.464vw] md1920:tracking-[-0.045vw]
          md720:text-[16px] md720:w-[150px] md720:leading-[17.6px] md720:tracking-[-0.32px]"
            >
              필요한 모든 것을 찾고,
              <br />할 수 있는 것을 나눠요.
            </p>
            <p
              className="mt-[8px] text-sayyo_subtext font-NanumSquare text-[20px] leading-[26px] tracking-[-0.4px]
          ...
          md720:mt-[2.18px] md720:w-[185px] md720:text-[16px] md720:leading-[14.3px] md720:tracking-[-0.22px]"
            >
              검증된 이웃들과 함께 다양한 분야의 필요한 것들찾거나 내가 할 수
              있는 것들을 안전하고 빠르게 거래할 수 있습니다.
            </p>
          </div>
        ...
        md720:mb-[72.3px] md720:w-full"
          >
            <div className="flex flex-col items-center w-[196px] md1920:w-[10.208vw] md720:w-[54.298px]">
              ...
              />
              <strong
                className="flex items-center h-[46px] font-NanumSquare text-[20px] font-bold
            ...
            <div className="flex flex-col items-center w-[196px] md1920:w-[10.208vw] md720:w-[54.298px]">
              ...
              />
              <strong
                className="flex items-center h-[46px] text-center font-NanumSquare text-[20px] font-bold
             md1920:h-[2.396vw] md1920_970:text-[1.042vw]
             md970:text-[10px]
            md720:text-[10px] md720:h-[30px]"
              >
        ...
        md720:mb-[16.59px] md720:w-full"
          >
            <div className="flex items-center">
              ...
              />
              <strong
                className="text-sayyo_wht font-NanumSquareRound text-[27.536px] leading-[33.044px] tracking-[-0.55px]
        ...
        md720:mb-[48.8px] md720:gap-[10.24px] md720:w-[328px]"
          >
            <div>
              <img
                src={assetSrc(img_offer_ko)}
                alt="img_post"
                className="mb-[34.25px] md1920:mb-[1.784vw] md1920:w-[13.854vw] md720:mb-[9.01px] md720:w-[75px]"
              />
              <strong
                className="mx-auto flex w-[150px] items-center justify-center text-sayyo_primary font-NanumSquareRound text-[40px] font-normal leading-[44px] tracking-[-0.8px]
